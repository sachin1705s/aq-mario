...
Downloadable dataset: [maxmill/aq-mario-smb1 on Hugging Face](https://huggingface.co/datasets/maxmill/aq-mario-smb1).

Trained model: [maxmill/aq-mario on Hugging Face](https://huggingface.co/maxmill/aq-mario).

See [`data/README.md`](data/README.md) for the shard schema, the RAM validation protocol, and
the Modal regeneration commands.
